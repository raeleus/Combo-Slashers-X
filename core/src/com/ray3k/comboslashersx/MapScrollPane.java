 ...
 * @author Nathan Sweet
 */
public class MapScrollPane extends WidgetGroup {
     ...
     */
    public MapScrollPane(Actor widget) {
     ...
     * @param widget May be null.
     */
    public MapScrollPane(Actor widget, Skin skin) {
     ...
     * @param widget May be null.
     */
    public MapScrollPane(Actor widget, Skin skin, String styleName) {
     ...
     * @param widget May be null.
     */
    public MapScrollPane(Actor widget, ScrollPaneStyle style) {
        if (style == null) {
        ...
        addCaptureListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y,
                ...
                getStage().setScrollFocus(MapScrollPane.this);
...
//                    cancelTouchFocus();
     ...
     * {@link #cancelTouchFocus()} is called. This causes any widgets inside the
